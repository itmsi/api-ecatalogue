...
const listValidation = [
  ...
  body('sort_by')
    .optional()
    .isIn(['type_engine_id', 'type_engine_name_en', 'type_engine_name_cn', 'created_at', 'updated_at'])
    .withMessage('Sort by harus salah satu dari: type_engine_id, type_engine_name_en, type_engine_name_cn, created_at, updated_at'),
  body('sort_order')
    .optional()
    .isIn(['asc', 'desc'])
