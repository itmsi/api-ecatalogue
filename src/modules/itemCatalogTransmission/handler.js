...
/**
 * Validate CSV row data for transmission items
 */
const validateCsvRow = (row, rowIndex) => {
  ...
  // Tidak ada validasi required untuk transmission items
...
const processCsvToDataItems = async (csvBuffer) => {
  ...
  // Convert CSV data ke format data_items (tanpa transmission_id dan type_transmission_id di row level)
...
const create = async (req, res) => {
  ...
  try {
    const { name_pdf, transmission_id, type_transmission_id, use_csv } = req.body;
    ...
    console.log('type_transmission_id:', type_transmission_id);
    console.log('dataItems[0]:', JSON.stringify(dataItems[0], null, 2));
    
    // Create items dengan transaction (pass transmission_id dan type_transmission_id dari root level)
...
const update = async (req, res) => {
  ...
  try {
    ...
    // Update items dengan transaction (pass transmission_id dan type_transmission_id dari root level)
