...
/**
 * Get all type steerings with pagination, search, and filtering
 */
...
/**
 * Get single type steering by ID
 */
...
const update = async (req, res) => {
  try {
    ...
    return baseResponse(res, { 
      data,
      message: 'Type steering berhasil diupdate' 
    });
  } catch (error) {
    return errorResponse(res, error);
  }
...
/**
 * Restore soft deleted type steering
 */
const restore = async (req, res) => {
  try {
    ...
    return baseResponse(res, { 
      data,
      message: 'Type steering berhasil direstore' 
    });
  } catch (error) {
    return errorResponse(res, error);
  }
