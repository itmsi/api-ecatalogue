...
/**
 * Get all type transmissions with pagination, search, and filtering
 */
...
/**
 * Get single type transmission by ID
 */
...
const create = async (req, res) => {
  try {
    ...
    return baseResponse(res, { 
      data,
      message: 'Type transmission berhasil dibuat' 
    }, 201);
  } catch (error) {
    return errorResponse(res, error);
  }
...
/**
 * Update existing type transmission
 */
const update = async (req, res) => {
  try {
    ...
    return baseResponse(res, { 
      data,
      message: 'Type transmission berhasil diupdate' 
    });
  } catch (error) {
    return errorResponse(res, error);
  }
...
const remove = async (req, res) => {
  try {
    ...
    return baseResponse(res, { 
      message: 'Type transmission berhasil dihapus' 
    });
  } catch (error) {
    return errorResponse(res, error);
  }
...
/**
 * Restore soft deleted type transmission
 */
const restore = async (req, res) => {
  try {
    ...
    return baseResponse(res, { 
      data,
      message: 'Type transmission berhasil direstore' 
    });
  } catch (error) {
    return errorResponse(res, error);
  }
